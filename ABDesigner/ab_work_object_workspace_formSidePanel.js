...
const ABViewForm = require("../AppBuilder/platform/views/ABViewForm");
const ABViewFormButton = require("../AppBuilder/platform/views/ABViewFormButton");
   ...
   constructor(App, idBase) {
      ...
      let _logic = (this._logic = {
         ...
         refreshForm: function (data) {
            ...
            form._views.forEach((v) => (v.id = App.AB.uuid()));
