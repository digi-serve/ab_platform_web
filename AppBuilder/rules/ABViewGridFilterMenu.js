...
module.exports = class ABViewGridFilterMenu {
   ...
   fromSettings(settings) {
      ...
      if (settings) {
         ...
         $$(this.ids.filterUser).setValue(
            settings.userFilterPosition || "toolbar"
         );

         $$(this.ids.filterGlobal).setValue(
            settings.globalFilterPosition || "default"
         );
