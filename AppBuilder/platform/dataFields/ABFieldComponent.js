   ...
   component(App, idBase) {
      ...
      var _logic = {
         ...
         clear: () => {
            ...
            for (var f in this.defaultValues) {
               ...
               if (component && component.setValue) {
                  ...
                  console.warn(
                     "!! could not find component for default value: name:" +
                        f +
                        " id:" +
                        ids[f]
                  );
         ...
         isValid: () => {
            ...
            if (
               ABField.reservedNames.indexOf(colName.trim().toLowerCase()) > -1
            ) {
               $$(ids.component).markInvalid(
                  "columnName",
                  "Could not use this column name"
               );
               return false;
            }
      ...
      var commonUI = ABField.definitionEditor(
         App,
         ids,
         _logic,
         this.fieldDefaults
