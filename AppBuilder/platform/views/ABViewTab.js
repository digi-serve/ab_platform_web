...
module.exports = class ABViewTab extends ABViewTabCore {
   ...
   //    var ids = {
   //       component: this.AB._App.unique(`${idBase}_component`),
   //       view: this.AB._App.unique(`${idBase}_view`),
   //    };
   ...
   componentOld(App) {
      ...
      //    }
      // });
      // let idBase = (this.idBase = `ABViewTab_${this.id}`);
      // var ids = {
      //    component: this.AB._App.unique(`${idBase}_component`),
      //    sidebar: this.AB._App.unique(`${idBase}_sidebar`),
      //    expandMenu: this.AB._App.unique(`${idBase}_expand_menu`),
      //    collapseMenu: this.AB._App.unique(`${idBase}_collapse_menu`),
      // };
      // let _ui = {};
      ...
      //          v.component = v.view.component(this.AB._App);
