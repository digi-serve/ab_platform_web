...
const ABPopupSortField = require("../../../ABDesigner/ab_work_object_workspace_popupSortFields");
const ABPopupFrozenColumns = require("../../../ABDesigner/ab_work_object_workspace_popupFrozenColumns");
const ABPopupMassUpdate = require("../../../ABDesigner/ab_work_object_workspace_popupMassUpdate");
...
const ABPopupExport = require("../../../ABDesigner/ab_work_object_workspace_popupExport");
...
module.exports = class ABViewGrid extends ABViewGridCore {
   ...
   component(App, objId) {
      ...
      var _logic = {
         ...
         callbackSortData: async (sort_settings) => {
